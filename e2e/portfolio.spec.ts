...
test.describe('Portfolio E2E Tests', () => {
    ...
    for (const section of sections) {
      ...
      if (await link.isVisible()) {
        ...
        const sectionElement = page
          .locator(
            `#${section.toLowerCase()}, [data-section="${section.toLowerCase()}"]`
          )
          .first()
  ...
  test('should display projects section', async ({ page }) => {
    ...
    const projectsSection = page
      .locator('[data-section="projects"], #projects')
      .first()
  ...
  test('should have working contact form', async ({ page }) => {
    ...
    const contactSection = page
      .locator('[data-section="contact"], #contact')
      .first()
    ...
    const hasContactInfo =
      (await page
        .locator('a[href^="mailto:"], a[href^="tel:"], form')
        .count()) > 0
