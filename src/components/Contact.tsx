      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto text-sm px-4">
            Looking for a quality engineer who understands cloud infrastructure,
            can architect scalable test systems, and speaks both QA and DevOps?
            AWS Certified with proven results: 60% faster deployments, 30%
            reduced test execution, zero-downtime releases through GitOps. ☁️
          </p>
          ...
          <div className="p-6 bg-gradient-to-br from-pass/5 to-emerald-50 dark:from-pass/10 dark:to-gray-800 rounded-lg border border-pass/20 dark:border-pass/30 text-center max-w-4xl mx-auto">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-4 leading-relaxed max-w-3xl mx-auto">
              Seeking Senior QA Engineer, Staff QA Engineer, or Platform
              Reliability Engineer roles. Specializing in cloud-native testing
              (AWS, Kubernetes), test automation at scale, and building quality
