...
<meta name="twitter:description" content="AWS Certified QA Engineer..." />
<meta name="twitter:image" content="/andrei-photo.jpg" />
```
...
- [x] Twitter Card tags (social sharing)
- [x] Canonical URL (SEO)
...
### **How HR Will Find You:**

1. **LinkedIn Profile** → Portfolio link → Your site ✅
2. **Google Search** → "Andrei Repo QA" → Your site ✅
3. **Resume PDF** → Portfolio URL → Your site ✅
4. **GitHub Profile** → Portfolio link → Your site ✅
5. **Referral** → Share link → Beautiful preview ✅
...
User-agent: *
Allow: /
Sitemap: https://andreiqa.click/sitemap.xml
```
...
1. **Meta Tags** - Perfect for search results
2. **Social Sharing** - Beautiful previews on LinkedIn/Twitter
3. **Structured Data** - Google understands your profile
4. **Sitemap** - Easy for search engines to crawl
5. **robots.txt** - Professional crawl management
6. **Semantic HTML** - Proper heading structure
7. **Alt Text** - All images described
8. **Fast Loading** - Optimized performance

**Result:** Maximum visibility for HR and recruiters! 🚀
